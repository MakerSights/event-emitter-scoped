  ...
  implements OnApplicationBootstrap, OnApplicationShutdown
{
  ...
  private subscribeSingleton(wrapper: InstanceWrapper) {
    ...
    this.subscribeAllListeners(instance, prototype, () =>
